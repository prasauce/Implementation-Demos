...
public class SimNativeAppTest {
    ...
    public void setup() throws MalformedURLException {
        ...
        //Instant Boot Simulator
        caps.setCapability("appium:platformVersion", "latest");
        caps.setCapability("appium:deviceName", "iPhone Instant Simulator");
        caps.setCapability("appium:app", "storage:filename=SauceLabs-Demo-App.Simulator.zip");  // The filename of the mobile app
        ...
        sauceOptions.setCapability("name", "iOS Simulator - Add Item To Cart");
