...
public class SimWebAppTest {
    ...
    public void setup() throws MalformedURLException {
        ...
        caps.setCapability("browserName", "Safari");  // The filename of the mobile app
        ...
        sauceOptions.setCapability("name", "iOS Simulator - Swag Labs User Login");
